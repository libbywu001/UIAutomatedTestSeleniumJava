...
import com.ca.action.ScreenShotCore;
...
public class TestResultListener extends TestListenerAdapter {
	private static LoggerControler logger = LoggerControler.getLoggerControler(TestResultListener.class);

	@Override
	public void onTestFailure(ITestResult tr) {
		super.onTestFailure(tr);
		ScreenShotCore.screenShots();
